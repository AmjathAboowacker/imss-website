        ...
        "AboutPage.useEffect": ()=>{
            const timer = setInterval({
                "AboutPage.useEffect.timer": ()=>{
                    setIndex({
                        "AboutPage.useEffect.timer": (prev)=>(prev + 1) % images.length
                    }["AboutPage.useEffect.timer"]);
                }
            }["AboutPage.useEffect.timer"], 4000); // 4 seconds interval
            return ({
...
//# sourceMappingURL=app_components_about_page_tsx_a7db677a._.js.map